...
public class DrillingRecordServiceImpl implements DrillingRecordService {
	...
	public boolean passSecondDynamicAudit(int id) {
		// TODO Auto-generated method stub
		boolean result = this.drillingRecordDao.passSecondDynamicAudit(id);
		if(result) {
			return true;
		}
		return false;
	...
	@Override
	public boolean passSecondAuditById(int id,double zking) {
		// TODO Auto-generated method stub
		boolean result = this.drillingRecordDao.passSecondAuditById(id,zking);
		if(result) {
			return true;
		}
		return false;
